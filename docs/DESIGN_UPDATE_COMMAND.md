...
3. **`VMUpdater`**
   ...
   - `_update_system_packages() -> UpdateResult`
     - Updates Azure Linux 4.0 packages with dnf5
     - Command: `sudo dnf5 upgrade -y`
...
2. dnf5 upgrades should complete before other package managers
3. Easier to troubleshoot failures
4. Lower risk of resource contention

**Order**:
1. System packages (dnf5) - Foundation, affects other tools
